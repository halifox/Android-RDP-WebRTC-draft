...
class PullMoreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pullFragment1 = PullFragment.newInstance("192.168.8.101", 8888)
        val pullFragment2 = PullFragment.newInstance("192.168.8.101", 8888)
        val pullFragment3 = PullFragment.newInstance("192.168.8.101", 8888)
        val pullFragment4 = PullFragment.newInstance("192.168.8.101", 8888)
