...
class PullMoreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initService(R.id.srv1)
        initService(R.id.srv2)
        initService(R.id.srv3)
        initService(R.id.srv4)

    }

    private fun initService(id: Int) {
                        ...
                        .handler(object : ChannelInitializer<SocketChannel>() {
                            override fun initChannel(channel: SocketChannel) {
                                ...
                                pipeline.addLast(object : SimpleChannelInboundHandler<String>() {
                                    ...
                                    private val surfaceViewRenderer = findViewById<SurfaceViewRenderer>(id)
