...
fun readSessionDescription(byteBuf: ByteBuf): SessionDescription {
    return SessionDescription(
        SessionDescription.Type.valueOf(byteBuf.readCharSequence(byteBuf.readInt(), Charset.defaultCharset()).toString()),
        byteBuf.readCharSequence(byteBuf.readInt(), Charset.defaultCharset()).toString(),
    )
}
